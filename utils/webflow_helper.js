...
export function getAPIClient(token, beta=true) {
  return new Webflow({ 
    ...
    headers: {
      "User-Agent": "Webflow Kitchen Sink App / 1.0.0",
    }
  });
}
...
export function getInstallUrl(scope = ['pages:read', 'sites:read', 'custom_code:read', 'webhooks:read', 'sites:write', 'custom_code:write', 'webhooks:write']){
